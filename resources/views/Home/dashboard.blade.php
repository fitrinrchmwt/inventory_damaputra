                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <a style="color : #CD5656" href="">Data Produk</a></div>
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <a style="color : #CD5656" href="">Data Bahan</a></div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">10</div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-database fa-2x text-gray-300"></i>
        ...
        <div class="col-xl-12 col-lg-10">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Notifikasi Stok Kurang</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <td>B0004</td>
                            <td>Abon Nabati</td>
                            <td class="highlight-orange">10</td>
                            </tr>
                            <tr>
                            <td>2</td>
                            <td>B0005</td>
                            <td>Abon Jamur Tiram</td>
