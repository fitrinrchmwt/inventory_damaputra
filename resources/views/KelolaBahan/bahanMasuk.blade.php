    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form id="formFilterBahanMasuk" class="row mb-3 formFilterBahanMasuk">
                    <div class="col-md-3">
                        <label>Nama Bahan</label>
                        <input type="text" class="form-control" id="filter_nama_bahan" placeholder="Contoh: Telur">
                    </div>
                    <div class="col-md-3">
