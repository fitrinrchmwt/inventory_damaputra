            ...
            <div class="table-responsive">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-damava shadow-sm" style="padding: 10px; margin-bottom: 10px;" data-bs-toggle="modal" data-bs-target="#modalProdukKeluar">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Mirota Kampus Babarsari</td>
                            <td><a href="#" class="d-none d-sm-inline-block btn btn-info shadow-sm" data-bs-toggle="modal" data-bs-target="#detailProdukKeluarModal">
                ...
                <!-- Modal -->   
                 <!-- Include modal dari file terpisah -->
                @include('KelolaProduk.detailProdukKeluar')
